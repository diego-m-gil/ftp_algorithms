...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=0.4]
        ...
        \foreach \x/\y/\label in {
            1/3/x1, 12/1/x2, 4/5/x3, 5/4/l1, 10/11/x5, 8/2/x6, 2/7/x7
        } {
            \node[circle,fill,inner sep=1pt] at (\x,\y) {};
            \node[font=\tiny] at (\x,\y+0.5) {\label};
        }
        
        % Splitting lines
        \draw[blue,thick] (5,0) -- (5,15) node[above] {$\ell_1$};
        \draw[red,thick] (0,7) -- (5,7) node[left] {$\ell_2$};
        \draw[red,thick] (5,11) -- (15,11) node[right] {$\ell_3$};
        \draw[blue,thick] (2,3) -- (2,7) node[left] {$\ell_4$};
        \draw[blue,thick] (4,7) -- (4,11) node[right] {$\ell_5$};
        \draw[blue,thick] (10,1) -- (10,11) node[right] {$\ell_6$};
    \end{tikzpicture}
    \caption*{Splitting lines in 2D plane}
\end{figure}
